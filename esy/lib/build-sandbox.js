...
var crawlBuild = function () {
  var _ref3 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)((_regenerator || _load_regenerator()).default.mark(function _callee3(packageJsonPath, context) {
    var sourcePath, packageJson, isRootBuild, command, dependencySpecs, _ref4, dependencies, errors, nextErrors, isInstalled, realSourcePath, source, nextSourcePath, id, maybeDuplicateSpec, spec;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 17:
            ...
            maybeDuplicateSpec = context.seenBuildSpecByName.get(packageJson.name);
