...
var fromDirectory = exports.fromDirectory = function () {
  var _ref = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)((_regenerator || _load_regenerator()).default.mark(function _callee(sandboxPath) {
    ...
    var resolutionCache, resolveCached, buildCache, crawlBuildCached, env, crawlContext, root;
    return (_regenerator || _load_regenerator()).default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            crawlBuildCached = function crawlBuildCached(sourcePath, context) {
              var build = buildCache.get(sourcePath);
              if (build == null) {
            ...
            _context.next = 8;
            return crawlBuild(sandboxPath, crawlContext);
...
var crawlDependencies = function () {
    ...
    return (_regenerator || _load_regenerator()).default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 25:
            _context2.next = 27;
            return context.crawlBuild((_path || _load_path()).dirname(dependencyPackageJsonPath), context);
  ...
  return function crawlDependencies(_x3, _x4, _x5) {
    return _ref2.apply(this, arguments);
  };
}();

var crawlBuild = function () {
  var _ref3 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)((_regenerator || _load_regenerator()).default.mark(function _callee3(sourcePath, context) {
    var packageJsonPath, packageJson, isRootBuild, command, dependencySpecs, _ref4, dependencies, errors, nextErrors, isInstalled, realSourcePath, source, nextSourcePath, id, spec;

    return (_regenerator || _load_regenerator()).default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            packageJsonPath = (_path || _load_path()).join(sourcePath, 'package.json');
            _context3.next = 3;
          ...
          case 17:
            ...
            spec = {
              ...
              command,
              shouldBePersisted: !(isRootBuild || !isInstalled) || Boolean(context.options.forRelease),
  ...
  return function crawlBuild(_x6, _x7) {
...
var readPackageJson = function () {
  ...
  return function readPackageJson(_x8) {
