...
exports.walk = exports.symlink = exports.readJson = exports.readFile = exports.copydir = exports.copy = exports._mkdtempSync = exports._mkdtemp = exports.mkdirp = exports.rmdirSync = exports.rmdir = exports.writeFileSync = exports.chmod = exports.writeFile = exports.readFileBuffer = exports.unlink = exports.realpath = exports.exists = exports.rename = exports.readdir = exports.lstat = exports.stat = undefined;
...
var symlink = exports.symlink = function () {
  ...
  return function symlink(_x7, _x8) {
...
var writeFileSync = exports.writeFileSync = fs.writeFileSync;

// Promote 3rd-party fs utils
var rmdir = exports.rmdir = (0, (_Promise || _load_Promise()).promisify)(require('rimraf'));
var rmdirSync = exports.rmdirSync = require('rimraf').sync;
var mkdirp = exports.mkdirp = (0, (_Promise || _load_Promise()).promisify)(require('mkdirp'));

// mkdtemp
var _mkdtemp = exports._mkdtemp = (0, (_Promise || _load_Promise()).promisify)(fs.mkdtemp);
var _mkdtempSync = exports._mkdtempSync = fs.mkdtempSync;
...
exports.copy = (_fsExtra || _load_fsExtra()).copy;
function copydirSync(from, to) {
  var params = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};

  (0, (_fsExtra || _load_fsExtra()).copySync)(from, to, {
    filter: function filter(filename) {
      return !(params.exclude && params.exclude.includes(filename));
    }
  });
