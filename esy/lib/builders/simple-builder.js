      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 55:
            ...
            _context9.next = 62;
            return (0, (_util || _load_util()).writeIntoStream)(logStream, `### ORIGINAL COMMAND: ${command}\n`);

          case 62:
            _context9.next = 64;
            return (0, (_util || _load_util()).writeIntoStream)(logStream, `### RENDERED COMMAND: ${renderedCommand}\n`);
